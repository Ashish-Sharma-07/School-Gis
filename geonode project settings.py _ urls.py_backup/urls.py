...
#from display_map.views import index as v_index
#from display_map.views import data as v_data
...
urlpatterns = patterns('',
		       #url(r'^vindex/$', v_index),
                       (r'^display_map/', include('geonode.display_map.urls')),
                       # Static pages
